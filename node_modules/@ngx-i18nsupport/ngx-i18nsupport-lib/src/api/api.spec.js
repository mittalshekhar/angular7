...
describe('ngx-i18nsupport-lib API test spec', () => {
    ...
    function readXmb(path) {
        const content = fs.readFileSync(path, ENCODING);
        return index_1.TranslationMessagesFileFactory.fromFileContent('xmb', content, path, ENCODING);
    }
    /**
    ...
    function readXtbWithMaster(path, masterPath) {
        ...
        if (masterPath) {
            ...
            return index_1.TranslationMessagesFileFactory.fromFileContent('xtb', content, path, ENCODING);
        }
    }
    /**
    ...
    function readFile(path, masterPath) {
        ...
        if (masterPath) {
            ...
            return index_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(content, path, ENCODING);
        }
    }
    describe('api tests', () => {
        ...
        it('should report wrong format as error', () => {
            try {
                index_1.TranslationMessagesFileFactory.fromFileContent('schrott', 'schrott', 'dummyfile', 'UTF-X');
            }
            catch (error) {
