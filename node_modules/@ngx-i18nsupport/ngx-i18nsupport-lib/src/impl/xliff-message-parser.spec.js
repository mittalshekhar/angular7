...
describe('message parse XLIFF 1.2 test spec', () => {
    ...
    function parsedMessageFor(normalizedString, sourceMessage) {
        const parser = new xliff_message_parser_1.XliffMessageParser();
    ...
    describe('xml to normalized message', () => {
        ...
        it('should set correct placeholer index (issue #84 ngx-i18nsupport) ', () => {
            ...
            const translatedMessage = parsedMessage.translate('New <xy></xy> was reported by <xy id="1"></xy>');
        ...
        it('should parse simple plural ICU message', () => {
            const parsedMessage = parsedMessageFromXML('{VAR_PLURAL, plural, =0 {just now} =1 {one minute ago} other {a few minutes ago} }');
...
//# sourceMappingURL=xliff-message-parser.spec.js.map