...
describe('ngx-i18nsupport-lib xmb test spec', () => {
    ...
    function readFile(path) {
        ...
        return api_1.TranslationMessagesFileFactory.fromFileContent('xmb', content, path, ENCODING);
    }
    describe('xmb format tests', () => {
        ...
        it('should return source language (by guessing from file name)', () => {
            ...
            const file2 = readFile(MASTER_DE_XMB);
        ...
        it('should loop over all trans units', () => {
            const translatedFile = readFile(MASTER_DE_XMB);
            let count = 0;
        ...
        it('should ignore change source content', () => {
            const file = readFile(MASTER_DE_XMB);
        ...
        it('should set source references', () => {
            ...
            const file2 = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(file.editedContent(), null, null);
        ...
        it('should copy a transunit from file a to file b', () => {
            ...
            const tu = file.transUnitWithId(ID_TO_MERGE);
            expect(tu).toBeTruthy();
            const targetFile = file.createTranslationFileForLang('de', null, false, true);
            expect(targetFile.fileType()).toBe(api_1.FILETYPE_XTB);
            ...
            const changedTargetFile = api_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(targetFile.editedContent(), null, null);
        ...
        it('should copy source to target and set a praefix and suffix', () => {
            ...
            const tu2 = file2.transUnitWithId(ID_TO_MERGE);
            expect(tu2.targetState()).toBe(api_1.STATE_FINAL); // FINAL because source is different than target
...
//# sourceMappingURL=xmb-file.spec.js.map