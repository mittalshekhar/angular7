...
describe('ngx-i18nsupport-lib XLIFF 2.0 test spec', () => {
    ...
    function readFile(path) {
        ...
        return index_1.TranslationMessagesFileFactory.fromFileContent('xlf2', content, path, ENCODING);
    }
    describe('XLIFF 2.0 format tests', () => {
        ...
        it('should read xlf file', () => {
            ...
            const tu = file.transUnitWithId(ID_APP_RUNS);
        ...
        it('should read xlf2 file and pretty print it and read it in again', () => {
            ...
            const rereadFile = index_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(formattedXml, null, null);
        ...
        it('should not add empty lines when beautifying (issue ngx-i18nsupport #97)', () => {
            ...
            const file2 = index_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(editedContentBeautified, null, null);
        ...
        it('should set description (creates new description)', () => {
            ...
            const notesElem = dom_utilities_1.DOMUtilities.getFirstElementByTagName(xmlElem, 'notes');
        ...
        it('should normalize unknown embedded html tags', () => {
            const file = readFile(TRANSLATED_FILE_SRC);
            const tu = file.transUnitWithId(ID_WITH_STRANGE_TAG);
        ...
        it('should remove a transunit by id', () => {
            ...
            const file2 = index_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(file.editedContent(), null, null);
            const tu2 = file2.transUnitWithId(ID_WITH_PLACEHOLDER);
        ...
        it('should translate source without or with target', () => {
            ...
            const file2 = index_1.TranslationMessagesFileFactory.fromUnknownFormatFileContent(file.editedContent(), null, null);
            const tu2 = file2.transUnitWithId(ID_APP_RUNS);
            ...
            const tu3 = file3.transUnitWithId(ID_APP_RUNS);
        ...
        it('should copy source to target for non default lang and set state new, native state initial, #57', () => {
            ...
            expect(tu2.nativeTargetState()).toBe('initial');
        });
        ...
        it('should copy a transunit to a specified position (#53)', () => {
            ...
            const existingElem = dom_utilities_1.DOMUtilities.getElementByTagNameAndId(doc, 'unit', ID_EXISTING);
            const newElem = dom_utilities_1.DOMUtilities.getElementByTagNameAndId(doc, 'unit', ID_TO_MERGE);
        ...
        it('should contain 2 ICU references in sourceContentNormalized (new syntax after angular #17344)', () => {
            const file = readFile(MASTER1SRC);
            const tu = file.transUnitWithId(ID_CONTAINS_TWO_ICU_WITH_EQUIV);
            expect(tu).toBeTruthy();
...
//# sourceMappingURL=xliff2-file.spec.js.map