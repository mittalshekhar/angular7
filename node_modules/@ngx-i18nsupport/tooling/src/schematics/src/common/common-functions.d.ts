 ...
 */
export declare function addXliffmergeDependencyToPackageJson(skipInstall: boolean | undefined): (host: import("@angular-devkit/schematics/src/tree/interface").Tree, context: import("@angular-devkit/schematics/src/engine/interface").TypedSchematicContext<{}, {}>) => import("@angular-devkit/schematics/src/tree/interface").Tree;
